...
/**/
         ...
         * access all of the items in an array
         * do not use i - i is used as an index
         * +prevents an out of bounds error
         * -limitations because the for each loop copies the value of values[n] to s
         *          thus you can't make a change to the array
         */
        for (int s: values)
        {
            System.out.println(s);
...
/**
 * Will take nums full of random numbers and fill the odds arry with only odd values
 * @param - nums array of random numbers
 * @param - odds empty array
 * @retrun - current size (companion variable), how many values are in the odds array
 */
