...
Address Tom   = new Address ("916 Elm Street","Flossmoor", "IL", 60148);
        ...
        /*
         * cruly brackets to define an array of Objects
         * makes the array the size of how many object in ini list
         */
        ...
        * thus we are changing the referance from null to an Object(Address)
        */
       for ( int i = 0; i < people.length; i++)
       {
           people[i] = new Address( i+"21 B Baker Street", "London", "UK", 60518);
       }
       
       /*
        * Can't change the referance to an Object
        * can change an attribute of that Object (.method)
        */
       int count = 0;
       for(Address s: people)
       {
           System.out.println(s);
           s.setAddress(count+"24 Conch Street");
           count++;
       }
