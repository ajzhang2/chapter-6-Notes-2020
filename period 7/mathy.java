...
public class mathy
{
	...
	*/
	 ...
	 * @return - an array of size pop with random numbers
	 * 
	 */
	public int[] poprandomArray ( int size, int range)
	{
	    ...
	    /*
	     * length of an array is a public constant number you can access
	...
	/**
	 * Removes a value at postition, moves all of the subsequent forward 1 index
	 * @param array to remove the value
	 * @param position to remove
	 * @param current size for  Paritally Filled Arrays
	 * @return the current size -1
	 */
	
	public int removeElement(int [] values, int pos, int currSize)
	{
